...
create_generated_clock -name ipbus_clk -source [get_pins infra/int_clocks/mmcm_user_clk/CLKIN1] [get_pins infra/int_clocks/mmcm_user_clk/CLKOUT1]
...
create_generated_clock -name clk_40_pseudo_i [get_pins infra/int_clocks/mmcm_user_clk/CLKOUT2]
